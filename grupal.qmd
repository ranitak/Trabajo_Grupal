...
abbrev_g<-abbrev |> 
  mutate(siglas=case_when(
    str_detect(denominacion, "SOCIALISTA") ~ "PSOE",
    str_detect(denominacion, "CIUDADANOS") ~ "C's",
    ...
    str_detect(denominacion, "UNIDAS PODEMOS|IU|Podem|Ezker Batua") ~ "UP",
    str_detect(denominacion, "
ESQUERRA REPUBLICANA DE CATALUNYA") ~ "ESQR",
