...
# Hacemos que si un partido tienen asiganda varias abreviaturas se quede con la 
primera y UNimos elecciones con abreaviaturas, para que en elecciones salga la 
abrevaitura de cada partido
...
# Separamos cod_mun en las 3 varibales de comunidad autonoma, provincia y 
...
# En la tabla surveys (encuestas) hacemos una columna partido, muy simliar al 
primero de elecciones, además quitamos los partidos que no tienen importancia 
en la encuesta, es decir que no han recibido datos
...
# Debes descartar las encuestas que: se refieran a elecciones anteriores a 2008,
sean a pie de urna, tamaño muestral desconocido o inferior a 500, tenga 1 día o
menos de trabajo de campo.
...
# 12.a) ¿Qué partido fue el ganador en los municipios con más de 100.000 
...
# 12.b) ¿Qué partido fue el segundo cuando el primero fue el PSOE? 
...
# 12.d)¿Cómo calibrar el error de las encuestas (recordemos que las encuestas 
son de intención de voto a nivel nacional)?
...
# ¿Qué casas encuestadoras acertaron más y cuáles se desviaron más de 
los resultados?
...
¿Qué 10 partidos obtuvieron mejores resultados en comparación con las 
predicciones de las encuestas?
...
# ¿Cuál es la relación entre el tamaño del censo y la fragmentación del voto 
(índice de Herfindahl)? Representar los valores de fragmentación en un mapa 
...
# ¿Qué comunidad autónoma tiene la mayor participación electoral promedio en las
...
# ¿Cuál es la relación entre la participación electoral y el tamaño de la
